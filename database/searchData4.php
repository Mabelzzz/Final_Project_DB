...
<h1>Search Data from Product Color</h1>
  ...
  $sql = "SELECT * FROM color_product WHERE ProductColor LIKE '%" . $keyword . "%';";
  ...
  <table id="keywords" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <th width="100"><div align="center"><span>Color</span></div></th>
    ...
    <tr>
      <td>
        ...
        <td align="center"><a href="deleteData3.php?ProductColor=<?php echo $objResult["ProductColor"]; ?>">Delete</a></td>
        <td align="center"><a href="updateSiz.php?ProductColor=<?php echo $objResult["ProductColor"]; ?>">Update</a></td>
        <tr>
    <?php
      $i++;
    }
