...
<br><br>
<div id="wrapper">
<h1>Search Data from Wholesale Store Name</h1>
</head>
<div align="center">

<body>
    <form action="searchData8.php" method="GET" name="StoreName">
        <table border="1">
            <tr>
        ...
        <br><td><button><a href="wholesale.php">Back to Wholesale Store</a></button></td>
