...
<h1>Product</h1>
  ...
  if (mysqli_num_rows($result) > 0) {
        echo "<br/>";
        echo 'จำนวนใบสั่งซื้อสินค้าทั้งหมด = ';
  ...
  <table id="keywords" cellspacing="0" cellpadding="0">
    <thead><br>
    <tr>
      <th width="100"><div align="center"><span>Purchase ID</span></div></th>
      <th width="500"><div align="center"><span>Date</span></div></th>
      <th width="100"><div align="center"><span>Customer ID</span></div></th>
    ...
    ?>
      <tr>
      <td><a href="allpurchase.php?PurchaseId=<?php echo $objResult["PurchaseId"];?>&CustomerId=<?php echo $objResult["CustomerId"];?>
        &PurchaseDate=<?php echo $objResult["PurchaseDate"];?>"><?php echo $objResult["PurchaseId"]; ?></a></td>
        <td><?php echo $objResult["PurchaseDate"]; ?></td>
        <td><?php echo $objResult["CustomerId"]; ?></td>
        <td align="center"><a href="deletePurId.php?PurchaseId=<?php echo $objResult["PurchaseId"]; ?>"><ul id="simple-menu">Delete</ul></a></td>
        <td align="center"><a href="updatePurId.php?PurchaseId=<?php echo $objResult["PurchaseId"]; ?>"><ul id="simple-menu">Update</ul></a></td>
