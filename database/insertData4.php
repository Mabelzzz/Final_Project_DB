...
<div id="demo-container">
  <ul id="simple-menu">
    ...
    <li><a href="insertCol.php" class="current"><span>Insert Color</span></a></li>
    <li><a href="deSizeId.php"><span>Delete Color</span></a></li>
    <li><a href="updateCol.php"><span>Update Color</span></a></li>
  </ul>
</div>
<br><br>
<div id="wrapper">
<h1> Insert Data : Color</h1>
</head>
<div align="center">
...
$Color = $_REQUEST['ProductColor'];
$Picture = $_REQUEST['ProductPicture'];

$sql = " INSERT INTO color_product VALUES ('$Id','$Color','$Picture'); ";
