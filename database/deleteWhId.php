...
<div id="demo-container">
  ...
  <li><a href="searchWh.php" span>Search Wholesale Store</span></a></li>
    ...
    <li><a href="deWhId.php" class="current"><span>Delete Wholesale Store</span></a></li>
    <li><a href="updateWh.php"><span>Update Wholesale Store</span></a></li>    
  </ul>
<br><br>
<div id="wrapper">
<h1> Delete Data : Wholesale Store</h1>
</head>

<div align="center">
<?php

$delete_ID = $_REQUEST['StoreId'];

require('connect.php');
echo "<br>";
$conn = mysqli_connect($servername, $username, $password, $dbname);
$sql = ' DELETE FROM wholesale_store WHERE StoreId = ' . $delete_ID . '; ';
