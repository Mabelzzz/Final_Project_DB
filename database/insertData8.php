...
<div id="demo-container">
  ...
  <li><a href="searchWh.php" span>Search Wholesale Store</span></a></li>
    <li><a href="insertWh.php" class="current"><span>Insert Wholesale Store</span></a></li>
...
<br><br>
<div id="wrapper">
<h1> Insert Data : Wholesale Store</h1>
</head>
<div align="center">
...
$StrId   = $_REQUEST['StoreId'];
$Name		  = $_REQUEST['StoreName'];
$Address		  = $_REQUEST['StoreAddress'];
$Tel	  = $_REQUEST['StoreTel'];

$sql = " INSERT INTO wholesale_store VALUES ('$StrId','$Name','$Address','$Tel'); ";
