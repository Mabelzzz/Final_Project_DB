...
<div id="demo-container">
  ...
  <li><a href="searchSize.php"><span>Search Size</span></a></li>
    ...
    ?>
   <div align="center">
    <form action="deleteSize.php" method="post" name="Product Size">
    <table border="1">
            <tr>
            <td>ProductId : </td>
                ...
                <td>ProductId : </td>
                <td><input type="text" name="ProductSize" <?php echo $objResult["ProductSize"]; ?>
                 
                </td> </tr>
                        </table>

        <br>
        <td><button><a href="size.php">Back to Size</a></button></td>
