...
<ul id="simple-menu">
    ...
    <li><a href="deEmpId.php" class="current"><span>Delete Employee</span></a></li>
    <li><a href="updateEmp.php"><span>Update Employee</span></a></li>   
  </ul>
</div>
<br><br>
<div id="wrapper">
<h1>Delete Data : Employee</h1>
</head>
<div align="center">

<?php

$delete_ID = $_REQUEST['EmpId'];

require('connect.php');
$conn = mysqli_connect($servername, $username, $password, $dbname);
$sql = ' DELETE FROM employee WHERE EmpId = ' . $delete_ID . '; ';
