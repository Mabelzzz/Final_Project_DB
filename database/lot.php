...
<div id="demo-container">
  <ul id="simple-menu">
    ...
    <li><a href="insertLot.php"><span>Insert Lot</span></a></li>
...
<h1> Lot Products </h1>
  ...
  if (mysqli_num_rows($result) > 0) {
    echo "<br/>";
        echo 'จำนวนล็อตของสินค้าทั้งหมด = ';
 ...
 <table id="keywords" cellspacing="0" cellpadding="0">
    ...
    ?>
      <tr>
        ...
        <td align="center"><a href="deleteLotId.php?LotId=<?php echo $objResult["LotId"]; ?>"><ul id="simple-menu">Delete</ul></a></td>
