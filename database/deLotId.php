...
<div id="demo-container">
  ...
  <li><a href="searchLot.php"><span>Search Lot</span></a></li>
    ...
    <li><a href="deLotId.php" class="current"><span>Delete Lot</span></a></li>
    <li><a href="updateLot.php"><span>Update Lot</span></a></li>    
  </ul>
</div><br><div id="wrapper"><br>
    <h1>Delete Data : Lot Products</h1>
    <?php
    ...
    ?>
   <div align="center">
    <form action="deleteLotId.php" method="post" name="Lot">
        <table border="1">
            <tr>
                <td>Lot ID : </td>
        ...
        <br>
<td><button><a href="lot.php">Back to Lot Products</a></button></td>
