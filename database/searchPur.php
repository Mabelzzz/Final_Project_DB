...
<body>
    <form action="searchData7.php" method="GET" name="PurchaseId">
        <table border="1">
            <tr>
                <td>Purchase Order ID keyword : </td>
                <td><input type="text" name="keyword"></td>
            </tr>
        </table>

        <br><td><button><a href="purchase.php">Back to Purchase Order</a></button></td>
