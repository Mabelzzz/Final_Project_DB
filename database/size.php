...
<h1>Size</h1>
  ...
  if (mysqli_num_rows($result) > 0) {
        echo "<br/>";
        echo 'จำนวนไซส์ทั้งหมดของสินค้าแต่ล่ะรายการ = ';
  ...
  <table id="keywords" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <th width="500"><div align="center"><span>Size</span></div></th>
    ...
    ?>
      <tr>
        ...
        <td align="center"><a href="deleteSize.php?ProductId=<?php echo $objResult["ProductId"];?>&ProductSize=<?php echo $objResult["ProductSize"];?>
        "><ul id="simple-menu">Delete</ul></a></td>
        <td align="center"><a href="updateSize.php?ProductId=<?php echo $objResult["ProductId"];?>&ProductSize=<?php echo $objResult["ProductSize"]; ?>"><ul id="simple-menu">Update</ul></a></td>
      </tr>
    <?php
      $i++;
    }
