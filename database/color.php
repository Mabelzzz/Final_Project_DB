...
<div id="demo-container">
  <ul id="simple-menu">
    ...
    <li><a href="searchCol.php"><span>Search Color</span></a></li>
...
<h1>Color</h1>
  ...
  if (mysqli_num_rows($result) > 0) {
        echo "<br/>";
        echo 'จำนวนสีทั้งหมดของสินค้าแต่ล่ะรายการ = ';
  ...
  <table id="keywords" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <th width="500"><div align="center"><span>Color</span></div></th>
      <th width="100"><div align="center"><span>Picture</span></div></th>
      <th width="500"><div align="center"><span>Delete</span></div></th>
    ...
    ?>
      <tr>
        ...
        ">View</a></td>
        <td align="center"><a href="deleteCol.php?ProductSize=<?php echo $objResult["ProductColor"]; ?>"><ul id="simple-menu">Delete</ul></a></td>
        <td align="center"><a href="updateCol.php?ProductSize=<?php echo $objResult["ProductColor"]; ?>"><ul id="simple-menu">Update</ul></a></td>
