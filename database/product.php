...
<h1>Product</h1>
  ...
  if (mysqli_num_rows($result) > 0) {
        echo "<br/>";
        echo 'จำนวนรูปแบบของสินค้าทั้งหมด = ';
  ...
  <table id="keywords" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <th width="100"><div align="center"><span>Price</span></div></th>
    ...
    ?>
      <tr>
        ...
        <td align="center"><a href="updateProId.php?ProductId=<?php echo $objResult["ProductId"]; ?>"><ul id="simple-menu">Update</ul></a></td>
      </tr>
    <?php
      $i++;
    }
