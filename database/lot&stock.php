...
<div id="demo-container">
  <ul id="simple-menu">
    ...
    <li><a href="color.php" ><span>Color</span></a></li>
  	<li><a href="lot&stock.php" class="current" ><span>Lot & Stock </span></a></li>
...
<h1> Lot Products (In stock)</h1>
  ...
  $sql = ' SELECT * FROM lot_product INNER JOIN stock_detail ON lot_product.LotId = stock_detail.LotId'; 
  ...
  if (mysqli_num_rows($result) > 0) {
    echo "<br/>";
        echo 'จำนวนรายการของสินค้าทั้งหมด = ';
 ...
 <table id="keywords" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <th width="150"><div align="center"><span>LotDate</span></div></th>
      <th width="150"><div align="center"><span>StoreId</span></div></th>
      <th width="100"><div align="center"><span>EmpId</span></div></th>
    ...
    ?>
      <tr>
        ...
        <td><?php echo $objResult["LotDate"]; ?></td>
