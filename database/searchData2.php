...
<h1>Search Data from Product Name</h1>
  ...
  <table id="keywords" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <th width="80"><div align="center"><span>ProductId</span></div></th>
      <th width="400"><div align="center"><span>Name</span></div></th>
    ...
    <tr>
      <td>
        ...
        <td align="center"><a href="deleteData2.php?ProductId=<?php echo $objResult["ProductId"]; ?>">Delete</a></td>
        <td align="center"><a href="updatePro.php?ProductId=<?php echo $objResult["ProductId"]; ?>">Update</a></td>
        <tr>
    <?php
      $i++;
    }
