...
<div id="demo-container">
<ul id="simple-menu">
    <li><a href="searchEmp.php"class="current"><span>Search Employee</span></a></li>
...
<br><br>
<div id="wrapper">
<h1>Search Data from Employee Name</h1>
</head>
<div align="center">
...
<body>
  ...
  $sql = "SELECT * 
    FROM employee
    WHERE EmpFirstname LIKE '%" . $keyword . "%';
    ";
  ...
  <table id="keywords" cellspacing="0" cellpadding="0">
    ...
    ?>
      <tr>
        ...
        <td><?php echo $objResult["EmpLastame"]; ?></td>
        ...
        <td align="center"><a href="deleteEmpId.php.php?EmpId=<?php echo $objResult["EmpId"]; ?>">Delete</a></td>
      </tr>
    <?php
      $i++;
    }
...
<td><button><a href="Employee.php">Back to Employee</a></button></td> <br><br>
  <?php
